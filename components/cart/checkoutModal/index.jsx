...
export default function CheckoutModal({
  ...
  const handleConfirmOrder = () => {
    const deliveryFee = calculateDeliveryFee();
    const message = `Olá, gostaria de realizar um pedido! Meu nome é ${
      localFormData.name
    }.
...
${orderDetails.products
  .map(
    (item) =>
      `${item.quantity}${item.unit === "KG" ? "g" : item.unit} - ${
        item.name
...
BAIRRO: ${
      localFormData.deliveryOption === "frete"
        ? localFormData.neighborhood
        : "-"
    }
CIDADE: ${
      localFormData.deliveryOption === "frete"
        ? localFormData.city === "charqueadas"
          ? "Charqueadas"
          : "São Jerônimo"
        : "-"
    }
        ...
        >
          ...
          <form className={styles.form} onSubmit={handleSubmit}>
            ...
            <div className={styles.radioGroup}>
              <label
                className={
                  localFormData.deliveryOption === "frete" ? styles.active : ""
                }
                onClick={() =>
              ...
              <label
                className={
                  localFormData.deliveryOption === "busca" ? styles.active : ""
                }
                onClick={() =>
                  handleLocalInputChange({
                    target: {
